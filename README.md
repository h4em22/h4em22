...
취약점 하나를 발견했을 때, 거기서 멈추지 않습니다. /n '왜 이 지점이 공격에 노출됐는가'를 끝까지 추적하는 **김혜미**입니다. /n 가상 환경에서 직접 재현·검증하며 **모의해킹과 악성코드 분석** 분야를 준비하고 있습니다.
...
- **팀 프로젝트 3회 전부 팀장, 2·3차 팀 1등**: 인프라 설계부터 발표까지 총괄해 두 번 연속 10팀 중 1등을 하여 우수상을 받았습니다.
