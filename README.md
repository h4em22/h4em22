...
모의해킹 / 악성코드 분석 분야 취업을 목표로 하는 김혜미입니다.
이론에 머무르지 않고 가상 환경에서 직접 취약점을 재현·검증하며, 근본 원인을 CWE 기준으로 끝까지 추적합니다.

**💡 강점**

- **취약점 11건, CWE 기준 분류·실증**: 국비과정 프로젝트에서 웹 취약점 11건을 발견해 전건 실증·조치했고, XSS+Session Fixation 연계로 무인증 관리자 세션 탈취까지 증명했습니다. 워게임 자체 문제 5종도 CWE 유형에 맞춰 직접 설계했습니다.
- **탐지 룰 18종 중 16종 실차단 검증 + BPFDoor 정적·동적 분석**: 공격하고 끝내지 않고 IDS/WAF 탐지 로직을 직접 설계·검증하며, 시그니처로 못 잡는 사각지대까지 짚어냅니다.
- **팀 프로젝트 3회 전부 팀장, 2·3차 팀 1등**: 인프라 설계부터 발표까지 총괄해 두 번 연속 10팀 중 1등과 우수상을 받았습니다.
...
- [이스트캠프] 가디언즈 정보보호 및 보안 인프라 운영 관리 10기 과정에서 **우수수료생 선정** (2026.08.07)
